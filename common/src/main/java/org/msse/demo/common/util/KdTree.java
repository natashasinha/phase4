 ...
 * Source <a href="https://github.com/phishman3579/java-algorithms-implementation/blob/master/src/com/jwetherell/algorithms/data_structures/KdTree.java">derived from</a>
...
public class KdTree<T extends KdTree.XYZPoint> implements Iterable<T> {
  ...
  public Collection<T> nearestNeighbourSearch(int k, T value) {
    ...
    // prev cannot be null, since root will not be null.
    KdNode leaf = prev;
